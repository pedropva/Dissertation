...
\extjurymember{Sandra Eliza Fontes de Avila}{Prof.}{Universidade Estadual de Campinas}%{Instituto de Computação}
%Universidade Estadual de Campinas
\extjurymember{Julio Cezar Duarte}{Prof.}{Instituto Militar de Engenharia}%{Secção de Engenharia de Computação}%Instituto Militar de Engenharia
}
...
\input{body/03_Theory}
\input{body/04_Dataset}
\input{body/05_Method}
\input{body/06_Results_and_Discussion}
\input{body/07_Conclusions}
...
\includepdf[pages=-]{body/VideoMR_Dataset_Datasheet}
...
% \input{body/03_Theory.tex}
% \input{body/04_Method.tex}
